...
function removeLocal(id){
 ...
 {user.role==="admin"&&summary&&<section className="stats-grid">{[["Total Customers",summary.totalCustomers],["Active Users",summary.activeUsers],["Total Customer this Month",summary.thisMonth],["Documents Saved",summary.imagesSaved]].map(([label,value])=><div className="stat-card" key={label}><div><strong>{value}</strong><span>{label}</span></div></div>)}</section>}
